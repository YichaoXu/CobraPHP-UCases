...
// 3. arrow func as parameters

function other_func($callback){
	$callback("3. ARROW AS PARAMETER");
}
other_func(fn ($data) => print($data)); // call other_func@User:12

// 4. This is a arrow with if condition
